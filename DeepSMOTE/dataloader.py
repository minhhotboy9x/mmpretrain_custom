...
class GenImageDataset(Dataset):
    def __init__(self, annotations_file, img_dir, transform=None, minor_classes=[]):
        """
        Args:
...
def build_dataloader(annotations_file, img_dir, transform, batch_size, minor_classes, num_workers, shuffle=True):
    """Hàm tạo DataLoader từ dataset."""
    dataset = GenImageDataset(annotations_file, img_dir, transform=transform, minor_classes=minor_classes)
